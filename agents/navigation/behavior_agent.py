...
class BehaviorAgent(Agent):
    ...
    def __init__(self, vehicle, ignore_traffic_light=False, behavior='normal'):
        ...
        self.ignore_traffic_light = True #ignore_traffic_light
        ...
        self.min_speed = 5
        self.behavior = None
        self._sampling_resolution = 1.2
        self.behavior_str = behavior
    ...
    def update_information(self, world):
        ...
        self.speed_limit = world.player.carla_agent.get_speed_limit()
        ...
        self.is_at_traffic_light = world.player.carla_agent.is_at_traffic_light()
    ...
    def set_destination(self, start_location, end_location, clean=True):
        """
    ...
    def traffic_light_manager(self, waypoint):
        ...
        # print ("Light ID: ", light_id, "light state: ", self.light_state)
        ...
        # print ("TO IGNORE: ", self.light_id_to_ignore)
    ...
    def collision_and_car_avoid_manager(self, location, waypoint):
        ...
        if self.direction == RoadOption.CHANGELANELEFT:
            ...
            vehicle_state, vehicle, distance = self._bh_is_vehicle_hazard(
                waypoint, location, vehicle_list, max(
                    self.behavior.min_proximity_threshold, self.speed_limit / 3), up_angle_th=35)
    ...
    def run_step(self, debug=False):
        ...
        # Checking if there's a junction nearby to slow down
            ...
            # print ("Intersection: ", min(self.behavior.max_speed, self.speed_limit - 5))
            control = self._local_planner.run_step(
